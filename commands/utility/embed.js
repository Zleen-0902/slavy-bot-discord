...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('embed')
        .setDescription('📢 Send neat messages using Slavy Embed')
    ...
    await interaction.deferReply();
        ...
        await interaction.editReply({ content: '✅ Embed successfully sent to this channel!', flags: [MessageFlags.Ephemeral] });
    }
};